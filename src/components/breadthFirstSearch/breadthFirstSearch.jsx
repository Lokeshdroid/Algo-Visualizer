...
const BreadthFirstSearch = () => {
  ...
  const generateArr = () => {
    ...
    const elemColor = Array(rows)
      .fill(0)
      .map((row) => Array(cols).fill("#1b1"));
    ...
    <>
      ...
      <center>
        <div style={{ color: "white", textAlign: "center", margin: "1rem" }}>
          Click on 2 boxes to select starting and ending positions
          <br />
        </div>
        <div
          style={{
